! function(e) {
    ...
    i.prototype = {
        ...
        e(this).find("a").not(".mm-next, .mm-prev").click(function() {
            o.close()
        }), e(this).find(".mmenu-custom-close").click(function() {
            o.close()
    ...
    a.prototype = {
        init: function() {
            ...
            }), t.menu_content.find("a").click(function(n) {
    ...
    c.prototype = {
        ...
        new c, e("#seocrawler-main-menu, #seocrawler-right-menu, #seocrawler-mobile-menu").each(function() {
            ...
            t.appendTo("body"), e(this).click(function() {
                t.fadeIn(200, function() {
                    e(this).addClass("seocrawler-active")
                })
            }), t.find(".seocrawler-top-search-close").click(function() {
                t.fadeOut(200, function() {
                    e(this).addClass("seocrawler-active")
                })
            }), t.find(".search-submit").click(function() {
        ...
        t.length && e(window).on("scroll", function() {
            ...
            e("a[href]").not('[href^="#"], [target="_blank"], .gdlr-core-js, .strip').click(function(s) {
